...
class AudioPlus {
  ...
  static Future<void> play(String filePath) async => AudioPlusPlatform.instance.play(filePath);
  ...
  static Future<void> increaseVolume(double volume) async => AudioPlusPlatform.instance.increaseVolume(volume);
  ...
  static Future<void> seekTo(int position) async => AudioPlusPlatform.instance.seekTo(position);

  /// Checks whether audio is currently playing.
  ///
  /// This method sends a request to the platform to determine whether audio
  /// is currently being played.
  static Future<bool?> get isPlaying async => AudioPlusPlatform.instance.isPlaying;
  ...
  static Future<double?> get currentPosition async => AudioPlusPlatform.instance.currentPosition;
  ...
  static Future<double?> get duration async => AudioPlusPlatform.instance.duration;
  ...
  static Future<void> isLooping(bool isLooping) async => AudioPlusPlatform.instance.isLooping(isLooping);
}
